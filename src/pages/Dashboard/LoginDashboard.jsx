...
const LoginDashboard = () => {
    return (
        <section className="h-full  flex justify-center items-center">
            ...
            <div className="flex w-full md:mt-36 mt-48 lg:w-1/2 justify-center items-center space-y-8">
                <div className="w-full px-8 md:px-32 lg:px-24">
                    <form className="bg-white rounded-md shadow-2xl p-5">
                        <h1 className="text-gray-800 font-bold text-2xl mb-1">SiteTitle</h1>
                        <p className="text-sm font-normal text-gray-600 mb-8">Welcome to Dashboard</p>
                        ...
                        <button type="submit" className="block w-full bg-gray-900 mt-5 py-2 rounded-2xl hover:bg-pink-500 hover:-translate-y-1 transition-all duration-500 text-white font-semibold mb-2 cursor-pointer">Login</button>
